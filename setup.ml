...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8eda7a7be60367d814607224d62221de) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_git", ["-q"]))];
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "A loyal and faithful synchronisation tool";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Dog"; "Dog_client"; "Dog_misc"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "dog";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "½°ÈNYÖPs¶\150Ê2Òc\005£";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
